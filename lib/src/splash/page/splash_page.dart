...
import 'package:gobook/src/common/components/app_font.dart';
import 'package:gobook/src/common/cubit/app_data_load_cubit.dart';
import 'package:gobook/src/common/enum/common_state_status.dart';
  ...
  Widget build(BuildContext context) {
    return BlocListener<AppDataLoadCubit, AppDataLoadState>(
      ...
      listener: (context, state) {
        context.read<SplashCubit>().chageLoadStatus(LoadStatus.auth_check);
      },
      child: Scaffold(
        body: Stack(
          fit: StackFit.expand,
